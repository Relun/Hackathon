const POKEMON = {
  "pokemon": [{
    ...
    "height": "27 de marzo de 2019",
    "weight": "Full time",
    "candy": "Estamos en búsqueda de una candidata con skills en UI, que nos ayude a acelerar la construcción de un producto que los usuarios amen frente a una interfaz de usuario funcional.Queremos contratar a alguien que aporte diversidad de ideas y enfoques que el equipo pueda aprender y aprovechar.La candidata debe asegurar la consistencia del diseño de la UI en todas nuestras plataformas - Web y Mobile. ",
    "candy_count": "Experiencia en desarrollo de productos B2B.Experencia en diseño para browser y aplicaciones nativas (Android y iOS).Conocimiento en producción de wireframes from scratch using Sketch o similar. Entender las capacidades (y limitaciones) de la tecnología. Tener una sólida base en tecnologías de front-end, específicamente HTML5, CSS, Javascript y al menos un Framework de JavaScript razonablemente popular (por ejemplo, React, Polymer, Angular, Ember). ",
    "egg": "En Frogmi te ofrecemos trabajar en un ambiente informal,pero serio, somos un equipo altamente exigente y esperamos incorporar a alguien igual o mejor. El equipo de trabajo es horizontal, tu opinión es tan importante como la del resto del equipo. Seguro de salud complementario a costo cero.",
    "spawn_chance": 0.69,
    "avg_spawns": 69,
    "spawn_time": "20:00",
    "multipliers": [1.58],
    ...
    "id": 2,
    "num": "Falabella Retail",
    "name": "Desarrolladora Front End",
    "img": "Viña del Mar, Chile",
    "type": [
      "frontEnd"
    ],
    "height": "29 de marzo de 2019",
    "weight": "Full time",
    "candy": "Actualmente nos encontramos en búsqueda de una desarrolladora Front End, que sea proactiva para implementar mejoras al sistema logístico actual, logrando diferenciar a nuestra empresa. Desarrollar funcionalidades en JS (javas script). Implementar maquetas HTML en base a diseños de UX/UI. Implementar tagging y métricas para herramientas de Analytics. Registro de mi navegación/historial de navegación con el sitio. ",
    "candy_count": "Javascript (ES5, ES6),CSS3, HTML5 (Responsive),ReactJS, NodeJS (deseable). Manejo de APIs REST. TDD, BDD, automatización de pruebas. Control de código y versiones (GIT). Inglés intermedio ",
    "egg": "En Falabella te ofrecemos trabajar en un ambiente informal,pero serio, somos un equipo altamente exigente y esperamos incorporar a alguien igual o mejor. El equipo de trabajo es horizontal, tu opinión es tan importante como la del resto del equipo. Seguro de salud complementario a costo cero.",
    "spawn_chance": 0.042,
    "avg_spawns": 4.2,
    "spawn_time": "07:00",
    "multipliers": [
    ...
    "height": "07 de marzo de 2019",
    "weight": "Full time",
    "candy": "Lo que hacemos en Modyo es desarrollar un software para crear y manejar la experiencia digital en las organizaciones más importantes de América Latina. Soñamos con ser una empresa de software de clase mundial y trabajamos día a día para lograrlo. Buscamos desarrolladora que quiera formar parte de nuestro equipo. Desarrollar sobre nuestra plataforma para importantes clientes. Mejorar y mantener aplicaciones actuales. Diseñar y construir modelos a partir de requerimientos. Aportar nuevas ideas! Esperamos que tu experiencia, opinión y proactividad nos ayuden a ser mejores. ",
    "candy_count":"Experiencia en desarrollo con el framework Ruby on Rails . Conocimientos (nociones) en JavaScript, desde jQuery hasta AngularJS, VueJS, ReactJS. Conocimiento en motores de indexación y en GITflow. Que seas un autodidacta por naturaleza, tu capacidad de aprender rápido es fundamental. Además debe ser ordenada y metódica. Manejo de Inglés técnico, leído y escrito.",
    "egg": "Ambiente de trabajo joven y entretenido. Acceso pagado a recursos para aprender. Oficina frente al Parque Bicentenario. Cafe rico ilimitado!",
    "spawn_chance": 0.017,
    "avg_spawns": 1.7,
    "spawn_time": "11:30",
    "multipliers": null,
    ...
    "id": 4,
    "num": "MANDOMEDIO. COM S.A",
    "name": "Desarrollador FrontEnd",
    "img": "Santiago, Chile",
    "type": [
      "frontEnd"
    ],
    "height": "30 de marzo de 2019",
    "weight": "Full time",
    "candy": "Estamos en búsqueda de una candidata con skills en UI, que nos ayude a acelerar la construcción de un producto que los usuarios amen frente a una interfaz de usuario funcional. Queremos contratar a alguien que aporte diversidad de ideas y enfoques que el equipo pueda aprender y aprovechar. Responsable de desarrollar aplicaciones y funcionalidades definidas para una determinada solución. Análisis y optimización de elementos de tecnología Hooks contribuyendo a la eficiencia y performance. Debe ser capaz de analizar, definir y desarrollar una determinada solución. ",
    "candy_count": "Experiencia al menos 2 años en front end. Habilidades de organización. Manejo de ingles, minimo nivel basico.Tener una sólida base en tecnologías de front-end. Desarrollar desde la programación hasta la implementación a través de la utilización de metodologías ágiles y desarrollo de plataformas web.",
    "egg": "Grato hambiente laboral,Crecimiento profesional, oportunidades de estudios en el pais como en el extranjero",
    "spawn_chance": 0.253,
    "avg_spawns": 25.3,
    "spawn_time": "08:45",
    "multipliers": [1.65],
    ...
    "height": "26 de marzo de 2019",
    "weight": "Full time",
    "candy": "Analizar el tráfico del sitio de manera cualitativa y cuantitativa utilizando herramientas tales como CrazyEgg y Google Analytics entre otras,Elaborar informes de UX del eCommerce basado en los análisis realizados, en los cuales se presentan mejoras concretas gráficas que maximicen la tasa de conversión",
    "candy_count": "Experiencia trabajando en áreas de Marketing, agencias, equipos de Front-end, product owners y equipos ágiles,Al menos 5 años en UX",
    "egg": "Ambiente laboral agradable y responsable, con beneficios asociados",
    "spawn_chance": 0.012,
    "avg_spawns": 1.2,
    "spawn_time": "19:00",
    "multipliers": [1.79],
    ...
    "height": "19 de marzo de 2019",
    "weight": "Full time",
    "candy": "Analizar el tráfico del sitio de manera cualitativa y cuantitativa utilizando herramientas tales como CrazyEgg y Google Analytics entre otras,Elaborar informes de UX del eCommerce basado en los análisis realizados, en los cuales se presentan mejoras concretas gráficas que maximicen la tasa de conversión",
    "candy_count": "Experiencia en desarrollo de Software, Java, Node.js e idealmente ATG,Comunicación escrita en inglés nivel avanzado (idealmente verbal tambien)",
    "egg":"seguro de salud, grato ambiente laboral y bonos",
    "spawn_chance": 0.0031,
    "avg_spawns": 0.31,
    "spawn_time": "13:34",
    "multipliers": null,
